...
const CommentsSection = ({ videoId, userData }) => {
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const res = await fetchData("GET", `https://stream-x.onrender.com/api/v1/Videos/comment/${videoId}`, { type: "video" });
    ...
    const handleAddComment = async (type, content, id) => {
        ...
        try {
            ...
            await fetchData("POST", `https://stream-x.onrender.com/api/v1/Videos/comment/create/${id}`, { content: content, type });
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        try {
            await fetchData("DELETE", `https://stream-x.onrender.com/api/v1/Videos/comment/delete/${commentId}`);
    ...
    const handleUpdateComment = async (commentId, newContent) => {
        try {
            await fetchData("PATCH", `https://stream-x.onrender.com/api/v1/Videos/comment/edit/${commentId}`, { content: newContent });
...
const WatchPage = () => {
    ...
    useEffect(() => {
        const loadPageData = async () => {
            try {
                setIsLoading(true);
                const vRes = await fetchData("GET", `https://stream-x.onrender.com/api/v1/Videos/watch/${videoId}`);
                await fetchData("GET", `https://stream-x.onrender.com/api/v1/users/update-watch-history/${videoId}`);
                ...
                const relatedRes = await fetchData("GET", "https://stream-x.onrender.com/api/v1/Videos");
                if (relatedRes?.Data) {
    ...
    const handleSubscribe = async () => {
        ...
        try {
            await fetchData("POST", `https://stream-x.onrender.com/api/v1/users/subscribe/${owner.username}`);
        } catch (e) { 
            setIsSubscribed(previousSubState);
    ...
    const handleLike = async () => {
        ...
        try {
            await fetchData("POST", `https://stream-x.onrender.com/api/v1/Videos/Likes/${video._id}`, { type: 'video' });
        } catch (e) {
