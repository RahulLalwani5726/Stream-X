...
const AddVideoModal = ({ isOpen, onClose, playlistId, existingVideoIds, onVideoAdded }) => {
    ...
    const fetchVideos = async () => {
        ...
        try {
            ...
            const res = await fetchData("GET", "https://stream-x.onrender.com/api/v1/Videos"); 
            if (res?.Data) {
    ...
    const handleAdd = async (video) => {
        ...
        try {
            ...
            await fetchData("PATCH", `https://stream-x.onrender.com/api/v1/playlist/add/${playlistId}/${video._id}`);
...
const PlaylistView = () => {
    ...
    useEffect(() => {
        const getPlaylist = async () => {
            try {
                setLoading(true);
                const res = await fetchData("GET", `https://stream-x.onrender.com/api/v1/playlist/view/${playlistId}`);
                if (res?.Data) {
    ...
    const handleDeletePlaylist = async () => {
        ...
        try {
            await fetchData("DELETE", `https://stream-x.onrender.com/api/v1/playlist/delete/${playlistId}`);
            navigate("/playlist");
        } catch (e) {
    ...
    const handleRemoveVideo = async (videoId) => {
        ...
        try {
            await fetchData("PATCH", `https://stream-x.onrender.com/api/v1/playlist/remove/${playlistId}/${videoId}`);
        } catch (e) {
